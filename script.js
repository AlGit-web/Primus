...
function scrollAnim() {
    ...
    if (el1.offsetTop - y < el1.offsetHeight * 2) {

        el1.style.animationPlayState = "running";
    }

    if (el2.offsetTop - y < el2.offsetHeight * 2) {
    ...
    if (el9.offsetTop - y <el9.offsetHeight/2){
        hashvel(73322,74422,"counter1")
        hashvel(100,1200,"counter2")
        hashvel(1100,2200,"counter3")
        hashvel(13900,15000,"counter4")
        hashvel(68900,70000,"counter5")
        document.querySelector(".cycle1").classList.add("run");
        document.querySelector(".cycle2").classList.add("run");
        document.querySelector(".cycle3").classList.add("run");
        document.querySelector(".cycle4").classList.add("run");
        document.querySelector(".cycle5").classList.add("run");
    }
}
